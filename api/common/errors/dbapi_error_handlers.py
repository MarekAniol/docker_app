...
from sqlalchemy.exc import InterfaceError, DatabaseError, DataError, OperationalError, InternalError, ProgrammingError, IntegrityError, NotSupportedError

    
    
def register_DBAPIError_errors_hadlers(app):
